    ...
    function Play() {
        ...
        const { isQuizInProgress, startQuiz, stopQuiz } = useContext(QuizContext);
                ...
                {isQuizInProgress && (
                    <div>
                        <nav>
                            ...
                            <button className="btn btn-warning" onClick={stopMyCurrentQuiz}> Cancel quiz </button>
                        </nav>
                        <article className="answersBlock">
